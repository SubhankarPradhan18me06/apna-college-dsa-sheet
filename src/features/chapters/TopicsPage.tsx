...
const TopicsPage: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto animate-fade-in">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Algorithm Topics</h1>
        <p className="text-gray-400">Select a topic to view problems and track your mastery.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {chapters.map((chapter: ChapterType) => (
          <Link
            ...
            className="card p-6 hover:border-brand-orange/50 hover:bg-dark-700/30 transition-all group"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-xl bg-dark-700 border border-surface-border flex items-center justify-center text-2xl text-brand-orange group-hover:scale-110 transition-transform">
                {chapter.icon}
              </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-gray-500 text-right uppercase tracking-widest mt-1">
