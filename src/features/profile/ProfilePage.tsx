  ...
  return (
    <div className="p-8 max-w-6xl mx-auto animate-fade-in">
      <div className="mb-10">
        ...
        <p className="text-gray-400">Analyze your algorithmic mastery and consistency.</p>
      </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="card p-8 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="relative mb-6">
              <div className="w-28 h-28 rounded-full border-4 border-dark-800 glow-orange overflow-hidden bg-dark-700 flex items-center justify-center text-4xl font-bold text-white">
                {user?.name?.charAt(0).toUpperCase()}
              </div>
              <div className="absolute bottom-1 right-1 w-6 h-6 rounded-full bg-emerald-500 border-4 border-dark-800" />
            </div>
            ...
            <div className="grid grid-cols-2 w-full gap-4 pt-6 border-t border-surface-border">
              <div>
                ...
                <p className="text-xl font-bold text-white">#4,209</p>
              </div>
              <div>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="card p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-sm font-bold text-white uppercase tracking-widest">Activity Heatmap</h3>
              <div className="flex items-center gap-2 text-[10px] text-gray-500">
                <span>Less</span>
                <div className="flex gap-1">
                  {[0, 1, 2, 3, 4].map(v => (
                    <div key={v} className={`w-3 h-3 rounded-sm ${v === 0 ? 'bg-dark-700' : 'bg-brand-orange'} opacity-${v * 20 + 20}`} />
                  ))}
                </div>
                <span>More</span>
              </div>
                ...
                {activity.map((val, i) => (
                  <div
                    ...
                    className={`w-4 h-4 rounded-sm transition-colors cursor-help ${
                      val === 0 ? 'bg-dark-700' : 'bg-brand-orange'
                    }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card p-6 flex items-center justify-between relative overflow-hidden">
              ...
              <div>
                <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-4">Current Streak</h3>
            ...
            <div className="card p-6 flex items-center justify-between relative overflow-hidden">
              <div className="absolute right-0 top-0 text-brand-orange/10 text-8xl font-black rotate-12 select-none">🏆</div>
              <div>
                <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-4">Mastery Score</h3>
                <p className="text-5xl font-black text-white mb-1">{stats?.percentage || 0}%</p>
